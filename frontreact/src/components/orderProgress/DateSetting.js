                ...
                <div className="searchdatemargin">
                    <Row style={{width: '100%', marginLeft: '0'}}>
                        <div className="input-group rowDiv">
                            <Col xs={2} className="datesearchfirstcol"><span
                                className="input-group-text datesearchfirstspan"><span
                                className="startdatetext">시작일</span></span></Col>
                            <Col xs={1.5} className="datesearchsecondcol"><input type="text" id="startyear"
                                                                                 className="form-control datesearchsecondinput "
                                                                                 placeholder="2023" maxLength='4'
                                                                                 onChange={(e) => {
                                                                                     this.onChangeDate(e)
                                                                                 }}/></Col>
                            <Col xs={0.5} className="datesearchthirdcol">년</Col>
                            <Col xs={0.5} className="datesearchfourthcol"><input type="text" id="startmonth"
                                                                                 className="form-control datesearchfourthinput"
                                                                                 placeholder="1" maxLength='2'
                                                                                 onChange={(e) => {
                                                                                     this.onChangeDate(e)
                                                                                 }}/></Col>
                            <Col xs={0.5} className="datesearchfivecol"
                                 style={{borderBottomRightRadius: "5px", borderTopRightRadius: "5px"}}>월</Col>
                            <Col xs={2} className="datesearchfirstcol"><span
                                className="input-group-text datesearchfirstspan" style={{marginLeft: "20px"}}><span
                                className="enddatetext">마감일</span></span></Col>
                            <Col xs={1.5} className="datesearchsecondcol"><input type="text" id="endyear"
                                                                                 className="form-control datesearchsecondinput"
                                                                                 placeholder="2023" maxLength='4'
                                                                                 onChange={(e) => {
                                                                                     this.onChangeDate(e)
                            ...
                            <Col xs={0.5} className="datesearchthirdcol">년</Col>
                            <Col xs={0.5} className="datesearchfourthcol"><input type="text" id="endmonth"
                                                                                 className="form-control datesearchfourthinput"
                                                                                 placeholder="1" maxLength='2'
                                                                                 onChange={(e) => {
                                                                                     this.onChangeDate(e)
                            ...
                            <Col xs={0.5} className="datesearchfivecol"
                                 style={{borderBottomRightRadius: "5px", borderTopRightRadius: "5px"}}>월</Col>
                            <Col xs={2} style={{width: "21.35%", marginLeft: "15px"}}><Button
                                style={{width: "100%", backgroundColor: "#1C91FB", borderColor: "#1C91FB"}}
                                className={"settingbtn"} onClick={this.onChangeDateSet}>조회</Button></Col>
                        </div>
                    </Row>
                </div>
            </div>
