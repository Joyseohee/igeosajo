            ...
            <div className="header">
                <Row className="header-wrapper">
                    ...
                    <Col sm="3" className="profile">
                        <Row>
                            <Col sm="3" className="photo">
                                ...
                                {user === "fakenum" && <div className="photo"></div>}
                            </Col>
                            <Col sm="9" className="info" >
                                <Row>
                                    <Col>
                                        {user !== "fakenum" && <div className="name">{username}</div>}
                                        {user === "fakenum" && <div className="name"></div>}
                                    </Col>
                                </Row>
                                <Row>
                                    <Col>
                                        {user !== "fakenum" && <div className="dept">
                    ...
                    <Col sm="1" className="logout">
                        {user !== "fakenum" && <div className="name">
